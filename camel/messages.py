...
class BaseMessage(schema.BaseMessage):
...
class SystemMessage(BaseMessage, schema.SystemMessage):
...
class AssistantSystemMessage(SystemMessage, schema.AIMessage):
...
AIMessage = AssistantSystemMessage


class UserSystemMessage(SystemMessage, schema.HumanMessage):
...
HumanMessage = UserSystemMessage


class ChatMessage(SystemMessage, schema.ChatMessage):
